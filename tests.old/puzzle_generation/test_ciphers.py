...
from glassdolls.puzzles.ciphers import (TranslationTable,
                                        TranslationTableStrKey, cesaer_cipher,
                                        substitution_cipher,
...
@pytest.fixture()
def text_with_spell_casaer_cipher_amt_24() -> str:
...
def test_cesaer_cipher_amt_24_outputs_correctly(
    text_with_spell: str, text_with_spell_casaer_cipher_amt_24: str
) -> None:
    SHIFT_AMOUNT = 24
    ciphertext = cesaer_cipher(text=text_with_spell, shift_amount=SHIFT_AMOUNT)
    assert ciphertext == text_with_spell_casaer_cipher_amt_24
